  ...
  return (
    <>
      <section className='bg-surface min-h-screen flex flex-col items-center justify-center px-6 pt-28 pb-20'>
        ...
        <p className='text-charcoal/55 font-light text-[16px] md:text-[21px] leading-[1.9] max-w-105 mb-14 text-center'>
          Our sales team is available Monday to Saturday from 10:00 to 18:00 at
          our Medchal experience centre, and online around the clock. We&apos;d
        ...
        >
          ...
          <button
            type='submit'
            className='group flex items-center justify-center gap-4 w-full h-13 rounded-full bg-brass text-limestone uppercase text-[11px] tracking-[0.22em] hover:bg-[#f0e6d6] hover:text-brass transition-colors duration-300 mt-2'
          >
            Send Message
        ...
        <div className='mt-16 flex flex-col sm:flex-row gap-10 sm:gap-16 text-center'>
          <div className='flex flex-col gap-1'>
            <span className='text-charcoal/30 text-[9px] uppercase tracking-[0.25em]'>
              Phone
            </span>
            <a
