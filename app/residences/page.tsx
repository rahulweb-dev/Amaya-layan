  ...
  return (
    <main className='bg-surface'>
      ...
      <PageHero
        ...
        imgSrc='/images/residence-reading.png'
        imgAlt='Amaya residence — home living'
      ...
      <section ref={splitRef} className='overflow-hidden'>
        <div className='flex flex-col md:flex-row items-stretch min-h-120'>
          <div
            className='split-img relative w-full md:w-[50%] shrink-0 overflow-hidden'
          ...
          <div className='split-text flex flex-col justify-center gap-7 px-8 md:px-14 lg:px-20 xl:px-28 py-16 md:py-0'>
            ...
            <h2
              className='text-navy font-light leading-[1.1] tracking-[0.02em] text-[28px]  md:text-[53px]'
              // style={{ fontSize: 'clamp(1.8rem, 3.5vw, 4rem)' }}
            >
              Not just a residence.
              <br />A way of living.
            </h2>
            <p className='text-charcoal/60 font-light md:text-[21px] text-[16px] leading-[1.9] max-w-105'>
              Every apartment at Amaya is planned with unusually generous
              balconies and cross ventilation, senior-friendly fixtures, and a
              layout that feels genuinely easy to move through — not just
              accessible in theory.
            </p>
            <p className='text-charcoal/45 font-light text-[16px] md:text-[21px] italic leading-[1.75] border-l border-stone/55 pl-5'>
      ...
      >
        <div className='text-center mb-16 md:mb-20'>
          ...
          <h2
            className='text-navy font-light leading-[1.1] tracking-wide text-[28px]  md:text-[53px]'
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10'>
          {PRINCIPLES.map((p) => (
            <div
              key={p.num}
              className='principle-card flex flex-col gap-5 border-t border-stone/50 pt-8'
            >
              <span className='text-charcoal/25 text-[11px] uppercase tracking-[0.35em]'>
                {p.num}
              </span>
              <h3 className='text-navy font-light leading-tight tracking-[0.02em] text-[16px] md:text-[21px]'>
                {p.title}
              </h3>
      ...
      <section className='py-20 md:py-32 bg-surface-alt'>
        <div className='max-w-375 mx-auto px-6 md:px-16 xl:px-24'>
          <div className='text-center mb-14 md:mb-20'>
            ...
            <h2
              className='text-navy font-light leading-[1.1] text-[28px]  md:text-[53px]'
              // style={{ fontSize: 'clamp(1.8rem, 3.8vw, 4.5rem)' }}
            >
            ...
            {RESIDENCES.map((r) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className='text-charcoal/40 text-[11px] uppercase tracking-[0.25em] mt-2'>
                    {r.area}
                  </p>
                </div>
                ...
                <div className='flex gap-8 border-t border-stone/40 pt-5'>
                  <div>
                    <div className='text-charcoal/30 text-[9px] uppercase tracking-[0.25em] mb-1.5'>
                      Carpet Area
                    </div>
                    <div className='text-charcoal/65 text-[13px] font-light'>
                      {r.carpet}
                    </div>
                  </div>
                  <div>
                ...
                <ul className='flex flex-col gap-2.5'>
                  {r.features.map((f) => (
                    <li
                      key={f}
                      className='flex items-start gap-3 text-charcoal/55 text-[13px] font-light leading-[1.6]'
                    >
                ...
                <div className='mt-auto pt-4 flex gap-3'>
                  ...
                  <button
                    className={`flex-1 h-11 rounded-full text-[11px] uppercase tracking-[0.2em] transition-all duration-300 ${
                      r.featured
                        ? 'bg-brass text-limestone hover:bg-[#f0e6d6] hover:text-brass'
          ...
          <p className='text-center text-charcoal/30 text-[11px] font-light leading-[1.75] max-w-xl mx-auto mt-10'>
            All sizes are indicative. Final built-up and carpet areas are
            subject to regulatory approval and may differ at handover.
          </p>
        </div>
      </section>
      ...
      {/* <section
        ref={statsRef}
        className='py-20 md:py-28 border-y border-stone/40'
      >
        <div className='max-w-375 mx-auto px-6 md:px-16 xl:px-24'>
      ...
      <section ref={ctaRef} className='py-28 md:py-44 px-6 text-center'>
        ...
        <h2
          className='text-navy font-light leading-[1.1] mb-8 max-w-2xl mx-auto text-[28px]  md:text-[53px]'
          // style={{ fontSize: 'clamp(1.8rem, 3.8vw, 4.5rem)' }}
        >
          Experience Amaya in person.
        </h2>
        <p className='text-charcoal/55 text-[16px] md:text-[21px] leading-[1.85] max-w-110 mx-auto mb-12'>
          Our experience centre is open Monday to Saturday, 10:00 to 18:00. Come
          and see the show apartment and meet the Vera Vita team.
        </p>
