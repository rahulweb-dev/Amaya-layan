  ...
  return (
    <>
      ...
      <section className='bg-surface min-h-screen flex flex-col items-center justify-center px-6 text-center pt-24'>
        ...
        <p className='text-charcoal/55 font-light text-[16px] md:text-[21px] leading-[1.9] max-w-130 mb-14'>
          Amaya offers investors access to one of India&apos;s fastest-growing
          senior living markets. Located in Medchal — on Nehru Outer Ring Road,
          Hyderabad — the development delivers strong capital appreciation,
          competitive rental yields, and long-term value backed by world-class
          infrastructure and an expanding resident community.
        </p>
        ...
        <button className='group flex items-center gap-4 px-8 h-13 rounded-full bg-brass text-limestone uppercase text-[11px] tracking-[0.22em] hover:bg-[#f0e6d6] hover:text-brass transition-colors duration-300'>
