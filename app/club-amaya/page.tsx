    ...
    <main className="bg-surface">
      ...
      <section className="overflow-hidden">
        <div className="flex flex-col md:flex-row items-stretch">
          ...
          <div className="flex flex-col justify-center gap-7 px-8 md:px-12 lg:px-20 xl:px-28 py-16 md:py-0">
            <p className="text-charcoal/40 text-[11px] uppercase tracking-[0.4em]">About Club Amaya</p>
            <h2
            ...
            <p className="text-charcoal/40 font-light text-[13px] italic leading-[1.75] border-l border-stone/55 pl-5">
      ...
      >
        <div className="text-center mb-14 md:mb-20">
          <p className="text-charcoal/40 text-[11px] uppercase tracking-[0.4em] mb-5">The Spaces</p>
          <h2
        ...
        <div className="max-w-225 mx-auto">
          {SPACES.map((space, idx) => {
            ...
            return (
              <div key={space.num} className="space-row border-b border-stone/40">
                <button
                  onClick={() => toggle(idx)}
                ...
                >
                  <div className="flex items-start gap-6 flex-1">
                    <span className="text-charcoal/25 text-[11px] tracking-[0.3em] mt-1.5 shrink-0">{space.num}</span>
                    <div className="flex flex-col gap-2">
                      <h3
                        className={`font-light transition-colors duration-300 leading-[1.2] tracking-[0.02em] ${isActive ? 'text-brass' : 'text-navy/85 group-hover:text-navy'}`}
                        style={{ fontSize: 'clamp(1.1rem, 2vw, 1.6rem)' }}
                      >
                        {space.title}
                      </h3>
                      {!isActive && (
                        <p className="text-charcoal/40 text-[13px] font-light leading-[1.75] max-w-120 hidden md:block">
                          {space.desc}
                        </p>
                      )}
                    </div>
                  </div>
                  <span className={`text-[22px] font-light transition-all duration-300 mt-1 shrink-0 ${isActive ? 'text-brass rotate-45' : 'text-charcoal/30 group-hover:text-charcoal/60'}`}>+</span>
                </button>
                ...
                >
                  <div className="pb-8 pl-0 md:pl-14 flex flex-col gap-4">
                    <p className="text-charcoal/65 text-[14px] md:text-[15px] font-light leading-[1.9] max-w-140">
                      {space.detail}
                    </p>
                    <p className="text-charcoal/40 text-[13px] font-light leading-[1.75] max-w-140 md:hidden">
                      {space.desc}
                    </p>
                  </div>
                </div>
      ...
      <section ref={featureRef} className="py-20 md:py-32 bg-surface-alt">
        <div className="max-w-375 mx-auto px-6 md:px-16 xl:px-24">
          <div className="text-center mb-14 md:mb-18">
            <p className="text-charcoal/40 text-[11px] uppercase tracking-[0.4em] mb-5">What to expect</p>
            <h2
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              >
                <span className="text-navy/20 text-[1.4rem] group-hover:text-navy/40 transition-colors duration-300">{icon}</span>
                <div>
                  <div className="text-navy/85 text-[13.5px] md:text-[14px] font-light tracking-[0.01em]">{label}</div>
                  <div className="text-charcoal/35 text-[11.5px] font-light mt-0.5">{sub}</div>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="relative overflow-hidden" style={{ height: 'clamp(300px, 45vw, 560px)' }}>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6 gap-4">
          <p className="text-limestone/50 text-[11px] uppercase tracking-[0.4em]">Planned</p>
          <h2
            className="text-limestone font-light leading-[1.1]"
      ...
      <section ref={ctaRef} className="py-28 md:py-44 px-6 text-center">
        <p className="text-charcoal/40 text-[11px] uppercase tracking-[0.4em] mb-6">Visit Club Amaya</p>
        <h2
