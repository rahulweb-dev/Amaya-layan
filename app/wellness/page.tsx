...
const CATEGORIES = [
  {
    ...
    items: [
      ...
      'Nutrition guidance',
      'Walking and movement trails',
      'Structured daily activity programmes',
    ],
  },
  {
    num: '02',
    ...
    items: [
      ...
      'Concierge and errand support',
      'Grocery and pharmacy assistance',
    ],
  },
  {
    num: '03',
    ...
    items: [
      ...
      'Trained on-site response staff',
  ...
  },
  {
    ...
    items: [
      ...
      'Ramp access throughout community',
    ],
  },
  {
    num: '05',
  ...
  return (
    <main className='bg-surface'>
      ...
      <PageHero
        ...
        imgSrc='/images/nature-walk.png'
        imgAlt='Amaya wellness — nature and community'
      ...
      <section className='py-20 md:py-32 px-6 md:px-16 xl:px-24 max-w-375 mx-auto'>
        <div className='grid grid-cols-1 md:grid-cols-[1fr_1fr] gap-12 md:gap-20 xl:gap-32 items-center'>
          <div className='flex flex-col gap-7'>
            ...
            <p className='text-charcoal/60 font-light text-[16px] md:text-[21px] leading-[1.9]'>
              Wellness at Amaya is not a facility or a programme schedule pinned
              to a noticeboard. It is the way the community is designed,
              staffed, and managed — so that help is always available without
              anyone having to ask loudly for it.
            </p>
            <p className='text-charcoal/60 font-light text-[16px] md:text-[21px] leading-[1.9]'>
              Every resident is different. Some will want daily fitness classes
              and an active social calendar. Others will want quiet days and
              good food. Amaya is built to accommodate both — simultaneously,
              without compromise.
            </p>
          </div>
          ...
          >
            <Image
              ...
              alt='Amaya residents enjoying the gardens'
              fill
            ...
            {CATEGORIES.map((cat) => (
              ...
              >
                <div className='flex items-start justify-between'>
                  <span className='text-charcoal/25 text-[11px] tracking-[0.35em]'>
                    {cat.num}
                  </span>
                </div>
                <div>
                  <h3 className='text-navy font-light leading-[1.2] tracking-[0.02em] mb-1.5 text-[16px] md:text-[21px]'>
                    {cat.title}
                  </h3>
                  <p className='text-brass/70 text-[10px] uppercase tracking-[0.3em]'>
                    {cat.subtitle}
                  </p>
                </div>
                <p className='text-charcoal/55 font-light text-[16px] md:text-[21px] leading-[1.9]'>
                  {cat.desc}
                </p>
                <ul className='flex flex-col gap-2 mt-auto pt-4 border-t border-stone/40'>
                  {cat.items.map((item) => (
                    ...
                    >
                      <span className='mt-2.5 w-1.75 h-1.75 rounded-full bg-navy/35 shrink-0' />
                      {item}
                    </li>
                  ))}
                </ul>
      ...
      >
        <div className='text-center mb-14 md:mb-20'>
          <p className='text-charcoal/40 text-[16px] md:text-[21px] uppercase tracking-[0.4em] mb-5'>
            Vera Vita Operating Principles
          </p>
          <h2 className='text-navy font-light leading-[1.1] text-[28px] md:text-[53px]'>
            The promise behind the place.
          </h2>
          <p className='text-charcoal/50 font-light text-[16px] md:text-[21px] leading-[1.85] max-w-lg mx-auto mt-6'>
            Vera Vita is the developer and long-term manager of Amaya. These are
            the operating principles that govern how the community is run.
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12'>
          {PRINCIPLES.map((p) => (
            <div
              key={p.title}
              className='principle-block flex flex-col gap-5 border-t border-stone/50 pt-8'
            >
      ...
      <section
        ref={statsRef}
        className='py-16 md:py-24 border-y border-stone/40'
      >
        <div className='max-w-375 mx-auto px-6 md:px-16 xl:px-24'>
          <div className='grid grid-cols-2 md:grid-cols-4 gap-10'>
            {[
              ...
              <div key={label} className='well-stat flex flex-col gap-2'>
                <div className='text-navy text-center leading-none text-[53px] font-bold'>
                  {num}
                </div>
      ...
      >
        <Image
          ...
          alt='Amaya — morning walk in the reserve forest'
          fill
        ...
        <div className='absolute inset-0 flex flex-col items-center justify-center text-center px-6 gap-5'>
          <p className='text-limestone/50 text-[16px] md:text-[21px] uppercase tracking-[0.45em]'>
            Nature as Wellness
          </p>
          <h2 className='text-limestone font-light leading-[1.1] max-w-3xl text-[28px] md:text-[53px]'>
            Beside a 700-acre
            <br />
            reserve forest.
          </h2>
          <p className='text-limestone/55 font-light text-[16px] md:text-[21px] leading-[1.85] max-w-md'>
            The forest is not a view. It is a daily destination — for morning
            walks, quiet sitting, and the particular kind of restoration that
            only comes from being among trees.
          </p>
        </div>
      </section>
      ...
      <section ref={ctaRef} className='py-28 md:py-44 px-6 text-center'>
        ...
        <p className='text-charcoal/55 text-[16px] md:text-[21px] leading-[1.85] max-w-110 mx-auto mb-12'>
          Speak to our team about how wellness and support work at Amaya. Visit
          the experience centre or request a brochure.
        </p>
