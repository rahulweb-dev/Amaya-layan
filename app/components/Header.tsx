      ...
      <header className="fixed top-0 left-0 z-[999] w-full">
        ...
        <div className="md:hidden relative max-w-[1700px]  mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            {/* Logo left — swaps white/black based on scroll */}
            <div ref={mLogoRef}>
              <Link href="/">
            ...
            <div className="flex items-center justify-between">
              ...
              <div ref={dLeftRef}>
                <button
                  onClick={() => setMenuOpen((v) => !v)}
                  aria-label={menuOpen ? 'Close menu' : 'Open menu'}
                  className={`group flex items-center gap-3 pl-4 pr-5 xl:pl-5 xl:pr-6 h-10.5 xl:h-12.5 rounded-full border uppercase text-xs xl:text-[13px] tracking-[0.18em] transition-colors duration-300 ${dBorder} ${dText} hover:bg-[#021A13] hover:text-white hover:border-[#021A13]`}
                >
