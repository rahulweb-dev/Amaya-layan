...
const SLIDES = [
  {
    ...
    img: '/images/slider-locations/orr.png',
  },
  {
    num: '20',
    label: 'RAJIV GANDHI INTL',
    img: '/images/slider-locations/RGIA.png',
  },
  { num: '5', label: 'MEDCHAL', img: '/images/slider-locations/medchal.png' },
  {
    num: '10',
    label: 'HITECH CITY',
    img: '/images/slider-locations/hitech-city.png',
  },
  {
    num: '25',
    label: 'HUSSAIN SAGAR',
    img: '/images/slider-locations/Hussian_sagar.png',
  },
  {
    num: '30',
    label: 'SECUNDERABAD',
    img: '/images/slider-locations/Secunderabad.png',
  },
];
...
export default function LocationSlider() {
  ...
  return (
    <section
      ref={sectionRef}
      className='bg-[#23384A] py-16 md:py-10 xl:py-18 overflow-hidden mt-[-50px]'
    >
      <div className='relative max-w-425 mx-auto px-6 md:ml-48 md:px-10 xl:px-16 2xl:px-10'>
        <div ref={cardsRef}>
          <Swiper
            onSwiper={(swiper) => {
          ...
          >
            {SLIDES.map((slide) => (
              <SwiperSlide key={slide.label}>
                <div
                  className='
      relative overflow-hidden rounded-sm group  h-[380px]  md:h-[450px] lg:h-[520px]
    '
                ...
                >
                  ...
                  <div className='absolute inset-0 flex flex-col items-center justify-center gap-1'>
                    <span
                      className='text-limestone font-light leading-none select-none text-[118px]'
                      // style={{ fontSize: 'clamp(90px, 12vw, 148px)' }}
                    >
                      {slide.num}
                    </span>
                    <div className='flex flex-col items-center -mt-2'>
                      <span className='text-limestone/80 text-[16px] font-light tracking-widest uppercase'>
                        mins
                      </span>
                      <span className='text-limestone/80 text-[16px] font-light tracking-widest uppercase'>
                        by car
                  ...
                  <div className='absolute bottom-0 left-0 right-0 flex items-center justify-center pb-7'>
                    <span className='text-limestone text-[16px] uppercase tracking-[0.28em] font-light'>
                      {slide.label}
                    </span>
                  </div>
                </div>
