  ...
  return (
    <section className="relative h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center px-5 gap-7 md:gap-9">
        {/* <p className="text-[#E7D8C6]/60 text-[19px] uppercase tracking-[0.45em]">
          Amaya — Medchal, Hyderabad
        </p> */}
        <h1
          className="max-w-5xl text-center  text-[#FDFCFA] uppercase font-normal text-[45px]  leading-[1.08] tracking-[0.02em] md:text-[64px]"
          // style={{ fontSize: 'clamp(2rem, 6vw, 6.5rem)' }}
        >
          Where life finds its <br/> perfect rhythm
        </h1>
        {/* <p className="text-[#E7D8C6]/70 text-center font-light text-[14px] md:text-[21px] leading-[1.8] max-w-[500px]">
