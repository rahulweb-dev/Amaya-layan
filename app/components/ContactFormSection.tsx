    ...
    >
      {checked && (
        <svg width="9" height="7" viewBox="0 0 10 8" fill="none">
          <path d="M1 4L3.8 7L9 1" stroke="#FDFCFA" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      )}
    </button>
  );
      ...
      <div className="max-w-425 mx-auto flex flex-col md:flex-row">
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-between gap-14 px-5 sm:px-10 md:px-16 xl:px-20 py-16 md:py-20 xl:py-28">
          ...
          <div className="flex flex-col gap-5">
            <p className="text-limestone/35 text-[10px] uppercase tracking-[0.35em]">
              Amaya — A Calm Residential Community
            </p>
            <h2
              className="text-limestone font-light leading-[1.05] tracking-[0.02em]"
              style={{ fontSize: 'clamp(2rem, 4.5vw, 3.8rem)' }}
            >
              Come and See It<br />for Yourself.
            </h2>
            <p className="text-limestone/55 text-[13px] md:text-[14px] font-light leading-[1.85] max-w-[460px]">
          ...
          <form onSubmit={(e) => e.preventDefault()} className="flex flex-col gap-9">
            ...
            <div className="flex flex-col sm:flex-row gap-8 sm:gap-10">
              ...
              {/* Name */}
              <div className="flex-1 flex flex-col gap-[10px] border-b border-limestone/15 pb-3">
                <label className="text-limestone/40 text-[9px] uppercase tracking-[0.32em]">Name *</label>
                <input
                  type="text"
                  required
                  className="bg-transparent text-limestone text-[13px] font-light outline-none w-full placeholder:text-limestone/20"
                />
              </div>
              ...
              <div className="flex-1 flex flex-col gap-[10px] border-b border-limestone/15 pb-3">
                ...
                <div className="flex items-center gap-2.5">
                  <div className="flex items-center gap-1.5 shrink-0 cursor-pointer">
                    ...
                    <span className="text-limestone/50 text-[13px] font-light">+91</span>
                    <svg width="8" height="5" viewBox="0 0 8 5" fill="none" className="text-limestone/30">
                      <path d="M1 1L4 4L7 1" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
                    </svg>
                  </div>
                  <input
                    type="tel"
                    className="bg-transparent text-limestone text-[13px] font-light outline-none flex-1 min-w-0"
                  />
                </div>
              </div>
              ...
              {/* Email */}
              <div className="flex-1 flex flex-col gap-[10px] border-b border-limestone/15 pb-3">
                <label className="text-limestone/40 text-[9px] uppercase tracking-[0.32em]">E-Mail</label>
                <input
                  type="email"
                  className="bg-transparent text-limestone text-[13px] font-light outline-none w-full"
                />
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-8">
              ...
              <div className="flex flex-col gap-[14px] max-w-115">
                <label className="flex items-start gap-3 cursor-pointer" onClick={() => setAgreed(v => !v)}>
                  ...
                  <span className="text-limestone/38 text-[10.5px] leading-[1.65]">
                    Please review our{' '}
                    <u className="text-limestone/60 cursor-pointer">Privacy Policy</u>
                    {' '}and{' '}
                    <u className="text-limestone/60 cursor-pointer">Personal Data Processing Terms</u>
                ...
                <label className="flex items-center gap-3 cursor-pointer" onClick={() => setNewsletter(v => !v)}>
                  ...
                  <span className="text-limestone/38 text-[10.5px]">
              ...
              <button
                type="submit"
                className="shrink-0 flex items-center justify-center gap-5 px-12 h-[54px] rounded-full bg-brass text-white uppercase text-[11px] tracking-[0.3em] hover:bg-[#967043] active:bg-[#7d5c35] transition-colors duration-300 min-w-55"
              >
                Book a Visit
        ...
        <div className="relative w-full md:w-[42%] min-h-[360px] md:min-h-0 shrink-0 overflow-hidden">
          ...
          />
          <div className="absolute inset-y-0 left-0 w-28 md:w-36 bg-linear-to-r from-navy-deep to-transparent" />
        </div>
      </div>
    </section>
  );
